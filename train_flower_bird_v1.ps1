...
$root = "C:\LoraTraining"
$outputDir = Join-Path $root "ich_flower_bird_outputs"
$logPath = Join-Path $root "flower_bird_lora_training.log"
$samplePrompts = Join-Path $root "flower_bird_sample_prompts.txt"
...
$args = @(
  ...
  "--train_data_dir=C:\LoraTraining\ich_flower_bird_train_en",
  "--resolution=512,512",
  "--enable_bucket",
  "--min_bucket_reso=256",
  "--max_bucket_reso=768",
  "--bucket_reso_steps=64",
  "--output_dir=C:\LoraTraining\ich_flower_bird_outputs",
  "--output_name=ICH_flower_bird_pattern_lora",
