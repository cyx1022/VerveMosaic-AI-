...
$logPath = Join-Path $PSScriptRoot "clean_other_flower_training.log"
$samplePrompts = "C:\LoraTraining\ich_clean_outputs_v1\other_flower\sample_prompts.txt"
...
$args = @(
  ...
  "--output_dir=C:\LoraTraining\ich_clean_outputs_v1\other_flower",
  "--output_name=ICH_clean_other_flower_lora_v1",
  ...
  "--clip_skip=1",
  "--logging_dir=C:\LoraTraining\ich_clean_outputs_v1\other_flower\logs",
  "--log_prefix=ICH_clean_other_flower_lora_v1",
