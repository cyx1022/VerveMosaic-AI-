...
$logPath = Join-Path $PSScriptRoot "clean_peony_training.log"
$samplePrompts = "C:\LoraTraining\ich_clean_outputs_v1\peony\sample_prompts.txt"
...
$args = @(
  ...
  "--output_dir=C:\LoraTraining\ich_clean_outputs_v1\peony",
  "--output_name=ICH_clean_peony_lora_v1",
  ...
  "--clip_skip=1",
  "--logging_dir=C:\LoraTraining\ich_clean_outputs_v1\peony\logs",
  "--log_prefix=ICH_clean_peony_lora_v1",
