...
$logPath = Join-Path $PSScriptRoot "peony_lora_training_v3_attr.log"
$samplePrompts = "C:\LoraTraining\ich_peony_outputs_v3_attr\sample_prompts_attr.txt"
...
$args = @(
  ...
  "--output_dir=C:\LoraTraining\ich_peony_outputs_v3_attr",
  "--output_name=ICH_peony_pattern_lora_v3_attr",
  ...
  "--clip_skip=1",
  "--logging_dir=C:\LoraTraining\ich_peony_outputs_v3_attr\logs",
  "--log_prefix=ICH_peony_pattern_lora_v3_attr",
