...
$logPath = Join-Path $PSScriptRoot "lotus_detail_v1_training.log"
$samplePrompts = "C:\LoraTraining\ich_lotus_outputs_detail_v1\sample_prompts.txt"
...
$args = @(
  ...
  "--train_data_dir=C:\LoraTraining\ich_lotus_train_detail_v1",
  "--resolution=512,512",
  "--enable_bucket",
  "--bucket_no_upscale",
  "--min_bucket_reso=256",
  ...
  "--output_dir=C:\LoraTraining\ich_lotus_outputs_detail_v1",
  "--output_name=ICH_lotus_pattern_lora_detail_v1",
  ...
  "--clip_skip=1",
  "--logging_dir=C:\LoraTraining\ich_lotus_outputs_detail_v1\logs",
  "--log_prefix=ICH_lotus_pattern_lora_detail_v1",
