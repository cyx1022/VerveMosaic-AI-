...
$logPath = Join-Path $PSScriptRoot "plum_lora_training_v1.log"
...
$args = @(
  ...
  "--train_data_dir=C:\LoraTraining\ich_plum_train_v1",
  "--resolution=512,512",
  "--enable_bucket",
  "--bucket_no_upscale",
  "--min_bucket_reso=256",
  ...
  "--output_dir=C:\LoraTraining\ich_plum_outputs_v1",
  "--output_name=ICH_plum_blossom_pattern_lora_v1",
  ...
  "--clip_skip=1",
  "--logging_dir=C:\LoraTraining\ich_plum_outputs_v1\logs",
  "--log_prefix=ICH_plum_blossom_pattern_lora_v1",
