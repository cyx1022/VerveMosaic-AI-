...
$logPath = Join-Path $PSScriptRoot "clean_flower_bird_training.log"
$samplePrompts = "C:\LoraTraining\ich_clean_outputs_v1\flower_bird\sample_prompts.txt"
...
$args = @(
  ...
  "--output_dir=C:\LoraTraining\ich_clean_outputs_v1\flower_bird",
  "--output_name=ICH_clean_flower_bird_lora_v1",
  ...
  "--clip_skip=1",
  "--logging_dir=C:\LoraTraining\ich_clean_outputs_v1\flower_bird\logs",
  "--log_prefix=ICH_clean_flower_bird_lora_v1",
