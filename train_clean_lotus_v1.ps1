...
$logPath = Join-Path $PSScriptRoot "clean_lotus_training.log"
$samplePrompts = "C:\LoraTraining\ich_clean_outputs_v1\lotus\sample_prompts.txt"
...
$args = @(
  ...
  "--output_dir=C:\LoraTraining\ich_clean_outputs_v1\lotus",
  "--output_name=ICH_clean_lotus_lora_v1",
  ...
  "--clip_skip=1",
  "--logging_dir=C:\LoraTraining\ich_clean_outputs_v1\lotus\logs",
  "--log_prefix=ICH_clean_lotus_lora_v1",
