...
$logPath = Join-Path $PSScriptRoot "peony_baseline_training.log"
$samplePrompts = "C:\LoraTraining\ich_peony_outputs_baseline_v1\sample_prompts.txt"
...
$args = @(
  ...
  "--train_data_dir=C:\LoraTraining\ich_peony_baseline_v1",
  "--resolution=512,512",
  "--enable_bucket",
  "--bucket_no_upscale",
  "--min_bucket_reso=256",
  ...
  "--output_dir=C:\LoraTraining\ich_peony_outputs_baseline_v1",
  "--output_name=ICH_peony_pattern_lora_baseline_v1",
  ...
  "--clip_skip=1",
  "--logging_dir=C:\LoraTraining\ich_peony_outputs_baseline_v1\logs",
  "--log_prefix=ICH_peony_pattern_lora_baseline_v1",
