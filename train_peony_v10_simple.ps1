...
$logPath = Join-Path $PSScriptRoot "peony_v10_simple_training.log"
$samplePrompts = "C:\LoraTraining\ich_peony_outputs_v10_simple\sample_prompts.txt"
...
$args = @(
  ...
  "--train_data_dir=C:\LoraTraining\ich_peony_train_v10_simple",
  "--resolution=512,512",
  "--enable_bucket",
  "--bucket_no_upscale",
  "--min_bucket_reso=256",
  ...
  "--output_dir=C:\LoraTraining\ich_peony_outputs_v10_simple",
  "--output_name=ICH_peony_pattern_lora_v10_simple",
  ...
  "--clip_skip=1",
  "--logging_dir=C:\LoraTraining\ich_peony_outputs_v10_simple\logs",
  "--log_prefix=ICH_peony_pattern_lora_v10_simple",
