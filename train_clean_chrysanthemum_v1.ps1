...
$logPath = Join-Path $PSScriptRoot "clean_chrysanthemum_training.log"
$samplePrompts = "C:\LoraTraining\ich_clean_outputs_v1\chrysanthemum\sample_prompts.txt"
...
$args = @(
  ...
  "--output_dir=C:\LoraTraining\ich_clean_outputs_v1\chrysanthemum",
  "--output_name=ICH_clean_chrysanthemum_lora_v1",
  ...
  "--clip_skip=1",
  "--logging_dir=C:\LoraTraining\ich_clean_outputs_v1\chrysanthemum\logs",
  "--log_prefix=ICH_clean_chrysanthemum_lora_v1",
