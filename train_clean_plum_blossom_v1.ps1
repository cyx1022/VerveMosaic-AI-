...
$logPath = Join-Path $PSScriptRoot "clean_plum_blossom_training.log"
$samplePrompts = "C:\LoraTraining\ich_clean_outputs_v1\plum_blossom\sample_prompts.txt"
...
$args = @(
  ...
  "--output_dir=C:\LoraTraining\ich_clean_outputs_v1\plum_blossom",
  "--output_name=ICH_clean_plum_blossom_lora_v1",
  ...
  "--clip_skip=1",
  "--logging_dir=C:\LoraTraining\ich_clean_outputs_v1\plum_blossom\logs",
  "--log_prefix=ICH_clean_plum_blossom_lora_v1",
