...
$logPath = Join-Path $PSScriptRoot "chrysanthemum_lora_training_v2.log"
$samplePrompts = "C:\LoraTraining\ich_chrysanthemum_outputs_v2\sample_prompts_v2.txt"
...
$args = @(
  ...
  "--train_data_dir=C:\LoraTraining\ich_chrysanthemum_train_v2",
  "--resolution=512,512",
  "--enable_bucket",
  "--bucket_no_upscale",
  "--min_bucket_reso=256",
  ...
  "--output_dir=C:\LoraTraining\ich_chrysanthemum_outputs_v2",
  "--output_name=ICH_chrysanthemum_pattern_lora_v2",
  ...
  "--clip_skip=1",
  "--logging_dir=C:\LoraTraining\ich_chrysanthemum_outputs_v2\logs",
  "--log_prefix=ICH_chrysanthemum_pattern_lora_v2",
