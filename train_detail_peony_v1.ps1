...
$logPath = Join-Path $PSScriptRoot "detail_peony_training.log"
$samplePrompts = "C:\LoraTraining\ich_detail_outputs_v1\peony\sample_prompts.txt"
...
$args = @(
  ...
  "--train_data_dir=C:\LoraTraining\ich_clean_train_v1\peony",
  "--resolution=768,768",
  "--enable_bucket",
  "--bucket_no_upscale",
  "--min_bucket_reso=384",
  ...
  "--output_dir=C:\LoraTraining\ich_detail_outputs_v1\peony",
  "--output_name=ICH_detail_peony_lora_v1",
  ...
  "--clip_skip=1",
  "--logging_dir=C:\LoraTraining\ich_detail_outputs_v1\peony\logs",
  "--log_prefix=ICH_detail_peony_lora_v1",
