...
$logPath = Join-Path $PSScriptRoot "peony_v9_morph_training.log"
$samplePrompts = "C:\LoraTraining\ich_peony_outputs_v9_morph\sample_prompts.txt"
...
$args = @(
  ...
  "--train_data_dir=C:\LoraTraining\ich_peony_train_v9_morph",
  "--resolution=512,512",
  "--enable_bucket",
  "--bucket_no_upscale",
  "--min_bucket_reso=256",
  ...
  "--output_dir=C:\LoraTraining\ich_peony_outputs_v9_morph",
  "--output_name=ICH_peony_pattern_lora_v9_morph",
  ...
  "--clip_skip=1",
  "--logging_dir=C:\LoraTraining\ich_peony_outputs_v9_morph\logs",
  "--log_prefix=ICH_peony_pattern_lora_v9_morph",
