...
$logPath = Join-Path $PSScriptRoot "detail_plum_blossom_training.log"
$samplePrompts = "C:\LoraTraining\ich_detail_outputs_v1\plum_blossom\sample_prompts.txt"
...
$args = @(
  ...
  "--train_data_dir=C:\LoraTraining\ich_clean_train_v1\plum_blossom",
  "--resolution=768,768",
  "--enable_bucket",
  "--bucket_no_upscale",
  "--min_bucket_reso=384",
  ...
  "--output_dir=C:\LoraTraining\ich_detail_outputs_v1\plum_blossom",
  "--output_name=ICH_detail_plum_blossom_lora_v1",
  ...
  "--clip_skip=1",
  "--logging_dir=C:\LoraTraining\ich_detail_outputs_v1\plum_blossom\logs",
  "--log_prefix=ICH_detail_plum_blossom_lora_v1",
