...
$logPath = Join-Path $PSScriptRoot "plum_lora_training_v2.log"
$samplePrompts = "C:\LoraTraining\ich_plum_outputs_v1\sample_prompts_v1.txt"
...
$args = @(
  ...
  "--network_weights=C:\LoraTraining\ich_plum_outputs_v1\ICH_plum_blossom_pattern_lora_v1.safetensors",
  "--tokenizer_cache_dir=C:\kohya_ss_link\tokenizer_cache",
  "--train_data_dir=C:\LoraTraining\ich_plum_train_v2",
  "--resolution=512,512",
  "--enable_bucket",
  "--bucket_no_upscale",
  "--min_bucket_reso=256",
  ...
  "--output_dir=C:\LoraTraining\ich_plum_outputs_v2",
  "--output_name=ICH_plum_blossom_pattern_lora_v2",
  ...
  "--clip_skip=1",
  "--logging_dir=C:\LoraTraining\ich_plum_outputs_v2\logs",
  "--log_prefix=ICH_plum_blossom_pattern_lora_v2",
